...
public class OverAllExpenses_Or_HomeExpenses extends javax.swing.JPanel {

    private final NavigationController navigation;
    private final DataController database;
    
    public OverAllExpenses_Or_HomeExpenses(DataController db, NavigationController nav) {
        this.database = db;
        this.navigation = nav;
        initComponents();
    }
